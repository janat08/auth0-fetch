...
function createCrypto(blockGlobalRandom = false) {
  const getRandomValues = assertsInRequest(import_crypto.webcrypto.getRandomValues, blockGlobalRandom);
  const generateKey = assertsInRequest(import_crypto.webcrypto.subtle.generateKey, blockGlobalRandom);
